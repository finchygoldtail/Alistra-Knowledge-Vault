...
updated: 2026-09-08
owner: Alistair
related: ["[[Legal Pack Index]]", "[[12 Data Protection Complaints Procedure]]", "[[Data Subject Rights Procedure]]", "[[DPA Requirements]]", "[[DPIA]]", "[[08 Privacy Notice and Website Legal Notices]]", "[[13 Client Framework Agreement]]", "[[Client Pricing Pack]]"]
---
...
| Privacy Notice | Yes | AMBER | Draft exists but placeholders, final roles, retention values, subprocessors/transfers and complaint wording must match production before publication. |
| Data Processing Agreement | Yes where AlistraGIS processes personal data for customer/controller | RED/AMBER | Detailed [[DPA Requirements]] exists; final execution-ready DPA needs solicitor approval/preparation. |
...
| Subject access / individual-rights process | Yes | AMBER | Procedure exists; legal timing now needs to be treated as known rather than undefined. Unified per-person locator/export/minimisation tooling remains desirable. |
...
| Cookie/device-storage notice | Yes/recommended | AMBER | Draft exists; finalise against actual production cookies/local-storage technologies. |
...
| Terms / SaaS licence | Commercially essential | AMBER | Drafts exist; now supplemented by [[13 Client Framework Agreement]] and Order Form structure. Solicitor redline required. |
...
| Pricing pack | Commercially required | GREEN/AMBER | Working modular pricing pack added 8 Sep 2026. Validate margin/infrastructure allowances before public publication. |
...
2. **Have solicitor finalise the Framework Agreement, SaaS/Terms and DPA as one coherent contract set.**
3. **Finish the Privacy Notice with real legal entity/registered-office, contact, retention and provider details.**
4. **Implement the privacy/data-protection complaint intake category and register.**
5. **Update DSAR procedure to use current statutory timing and run a mock request.**
