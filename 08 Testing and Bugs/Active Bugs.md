...
- [x] ~~The commercial package export stated the pre-variation snapshot price as "Total Value" and omitted the certified value entirely.~~ Anyone paying a subcontractor from that spreadsheet would have underpaid by the value of every approved variation. Found 2026-08-21 while re-checking the go-live blockers in [[Commercial Allocation Billing Architecture]] -- the note had asked for completion, revision and certification evidence to be verified, all three of which were genuinely missing, but had not named this one. Fixed and deployed the same day.
